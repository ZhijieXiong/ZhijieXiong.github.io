...
const MODEL_TYPE = {
  KT: {
    "Concept Level": ["DKT", "DKVMN", "DKTForget", "ATKT", "CLKT"],
    "Question Level": ["qDKT", "AKT", "SimpleKT", "SparseKT", "DIMKT", "LPKT", "LBKT", "MIKT", "QIKT", "QDCKT", "DyGKT", "GRKT", "CKT", "HDLPKT", "DTransformer"],
    // 添加更多类型...
  },
  CD: {
