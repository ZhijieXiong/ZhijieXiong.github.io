const DATA = {
  ...
  "Ednet-kt1-longest-seqs-5000": {
    num_user: 5000,
    num_interaction: 26056109,
    num_concept: 188,
    num_question: 12272,
    average_seq_len: 5211.22,
    average_question_acc: 0.702,
    question_sparsity: 0.6793,
    concept_sparsity: 0.08,
  ...
  "DBE-KT22": {
    num_user: 1214,
    num_interaction: 158342,
    num_concept: 93,
    num_question: 212,
    average_seq_len: 130.43,
    average_question_acc: 0.7646,
    question_sparsity: 0.3861,
    concept_sparsity: 0.3534,
    side_info: "timestamp, concept_text, question_text",
    link: "https://dataverse.ada.edu.au/dataset.xhtml?persistentId=doi:10.26193/6DZWOH",
  },
};
